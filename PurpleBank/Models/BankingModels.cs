...
namespace PurpleBank.Models
{
    ...
    {
        private string _baseUrl = "https://data.holder.com.au/cds-au/v1";
        ...
        public virtual System.Threading.Tasks.Task<ResponseBankingAccountListV2> ListAccountsAsync(ProductCategory? product_category, OpenStatus? open_status, bool? is_owned, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return ListAccountsAsync(product_category, open_status, is_owned, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingAccountListV2> ListAccountsAsync(ProductCategory? product_category, OpenStatus? open_status, bool? is_owned, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ResponseErrorListV2>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[400 - Invalid Field](#error-400-field-invalid)</li><li>[400 - Invalid Page Size](#error-400-field-invalid-page-size)</li><li>[400 - Invalid Version](#error-400-header-invalid-version)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 406)
                        {
                            ...
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[406 - Unsupported Version](#error-406-header-unsupported-version)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 422)
                        {
                            ...
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[422 - Invalid Page](#error-422-field-invalid-page)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingAccountsBalanceList> ListBalancesBulkAsync(ProductCategory2? product_category, OpenStatus2? open_status, bool? is_owned, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return ListBalancesBulkAsync(product_category, open_status, is_owned, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingAccountsBalanceList> ListBalancesBulkAsync(ProductCategory2? product_category, OpenStatus2? open_status, bool? is_owned, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/balances?");
            if (product_category != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("product-category") + "=").Append(System.Uri.EscapeDataString(ConvertToString(product_category, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingAccountsBalanceList> ListBalancesSpecificAccountsAsync(int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, RequestAccountIds body)
        {
            return ListBalancesSpecificAccountsAsync(page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, body, System.Threading.CancellationToken.None);
        }
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 422)
                        {
                            ...
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[422 - Invalid Page](#error-422-field-invalid-page)</li><li>[422 - Unavailable Banking Account](#error-422-authorisation-unavailable-banking-account)</li><li>[422 - Invalid Banking Account](#error-422-authorisation-invalid-banking-account)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingAccountsBalanceById> GetBalanceAsync(string accountId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return GetBalanceAsync(accountId, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingAccountsBalanceById> GetBalanceAsync(string accountId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            if (accountId == null)
                throw new System.ArgumentNullException("accountId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/{accountId}/balance");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[400 - Invalid Field](#error-400-field-invalid)</li><li>[400 - Invalid Version](#error-400-header-invalid-version)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[404 - Unavailable Banking Account](#error-404-authorisation-unavailable-banking-account)</li><li>[404 - Invalid Banking Account](#error-404-authorisation-invalid-banking-account)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 406)
                        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingAccountByIdV3> GetAccountDetailAsync(string accountId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return GetAccountDetailAsync(accountId, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingAccountByIdV3> GetAccountDetailAsync(string accountId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            if (accountId == null)
                throw new System.ArgumentNullException("accountId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/{accountId}");
            urlBuilder_.Replace("{accountId}", System.Uri.EscapeDataString(ConvertToString(accountId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingTransactionList> GetTransactionsAsync(string accountId, string oldest_time, string newest_time, string min_amount, string max_amount, string text, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return GetTransactionsAsync(accountId, oldest_time, newest_time, min_amount, max_amount, text, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingTransactionList> GetTransactionsAsync(string accountId, string oldest_time, string newest_time, string min_amount, string max_amount, string text, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            if (accountId == null)
                throw new System.ArgumentNullException("accountId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/{accountId}/transactions?");
            urlBuilder_.Replace("{accountId}", System.Uri.EscapeDataString(ConvertToString(accountId, System.Globalization.CultureInfo.InvariantCulture)));
            if (oldest_time != null)
            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[400 - Invalid Field](#error-400-field-invalid)</li><li>[400 - Invalid Page Size](#error-400-field-invalid-page-size)</li><li>[400 - Invalid Version](#error-400-header-invalid-version)</li><li>[400 - Invalid Date](#error-400-field-invalid-date-time)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingTransactionById> GetTransactionDetailAsync(string accountId, string transactionId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return GetTransactionDetailAsync(accountId, transactionId, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingTransactionById> GetTransactionDetailAsync(string accountId, string transactionId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            if (accountId == null)
                throw new System.ArgumentNullException("accountId");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/{accountId}/transactions/{transactionId}");
            urlBuilder_.Replace("{accountId}", System.Uri.EscapeDataString(ConvertToString(accountId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingDirectDebitAuthorisationList> ListDirectDebitsAsync(string accountId, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return ListDirectDebitsAsync(accountId, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingDirectDebitAuthorisationList> ListDirectDebitsAsync(string accountId, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            if (accountId == null)
                throw new System.ArgumentNullException("accountId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/{accountId}/direct-debits?");
            urlBuilder_.Replace("{accountId}", System.Uri.EscapeDataString(ConvertToString(accountId, System.Globalization.CultureInfo.InvariantCulture)));
            if (page != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("page") + "=").Append(System.Uri.EscapeDataString(ConvertToString(page, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
        ...
        {
            return ListDirectDebitsBulkAsync(product_category, open_status, is_owned, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/direct-debits?");
            if (product_category != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("product-category") + "=").Append(System.Uri.EscapeDataString(ConvertToString(product_category, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingDirectDebitAuthorisationList> ListDirectDebitsSpecificAccountsAsync(int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, RequestAccountIds body)
        {
            return ListDirectDebitsSpecificAccountsAsync(page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingScheduledPaymentsList> ListScheduledPaymentsAsync(string accountId, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return ListScheduledPaymentsAsync(accountId, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ResponseBankingScheduledPaymentsList> ListScheduledPaymentsAsync(string accountId, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/accounts/{accountId}/payments/scheduled?");
            urlBuilder_.Replace("{accountId}", System.Uri.EscapeDataString(ConvertToString(accountId, System.Globalization.CultureInfo.InvariantCulture)));
            if (page != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("page") + "=").Append(System.Uri.EscapeDataString(ConvertToString(page, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
        ...
        {
            return ListScheduledPaymentsBulkAsync(product_category, open_status, is_owned, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/payments/scheduled?");
            if (product_category != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("product-category") + "=").Append(System.Uri.EscapeDataString(ConvertToString(product_category, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingScheduledPaymentsList> ListScheduledPaymentsSpecificAccountsAsync(int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, RequestAccountIds body)
        {
            return ListScheduledPaymentsSpecificAccountsAsync(page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingPayeeListV2> ListPayeesAsync(Type? type, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return ListPayeesAsync(type, page, page_size, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingPayeeListV2> ListPayeesAsync(Type? type, int? page, int? page_size, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/payees?");
            if (type != null)
            {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingPayeeByIdV2> GetPayeeDetailAsync(string payeeId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers)
        {
            return GetPayeeDetailAsync(payeeId, x_v, x_min_v, x_fapi_interaction_id, x_fapi_auth_date, x_fapi_customer_ip_address, x_cds_client_headers, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingPayeeByIdV2> GetPayeeDetailAsync(string payeeId, string x_v, string x_min_v, string x_fapi_interaction_id, string x_fapi_auth_date, string x_fapi_customer_ip_address, string x_cds_client_headers, System.Threading.CancellationToken cancellationToken)
        {
            if (payeeId == null)
                throw new System.ArgumentNullException("payeeId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/payees/{payeeId}");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<ResponseErrorListV2>("The following error codes MUST be supported:<br/><ul class=\"error-code-list\"><li>[404 - Unavailable Resource](#error-404-resource-unavailable)</li><li>[404 - Invalid Resource](#error-404-resource-invalid)</li></ul>", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 406)
                        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingProductListV2> ListProductsAsync(Effective? effective, string updated_since, string brand, ProductCategory5? product_category, int? page, int? page_size, string x_v, string x_min_v)
        {
            return ListProductsAsync(effective, updated_since, brand, product_category, page, page_size, x_v, x_min_v, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingProductListV2> ListProductsAsync(Effective? effective, string updated_since, string brand, ProductCategory5? product_category, int? page, int? page_size, string x_v, string x_min_v, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/products?");
            if (effective != null)
            {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ResponseBankingProductByIdV4> GetProductDetailAsync(string productId, string x_v, string x_min_v)
        {
            return GetProductDetailAsync(productId, x_v, x_min_v, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ResponseBankingProductByIdV4> GetProductDetailAsync(string productId, string x_v, string x_min_v, System.Threading.CancellationToken cancellationToken)
        {
            if (productId == null)
                throw new System.ArgumentNullException("productId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/banking/products/{productId}");
    ...
    public partial class BankingAccountV2
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public BankingAccountV2OpenStatus OpenStatus { get; set; } = PurpleBank.Models.BankingAccountV2OpenStatus.OPEN;
    ...
    public partial class BankingLoanAccountV2
    {
        ...
        [Newtonsoft.Json.JsonProperty("repaymentType", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public BankingLoanAccountV2RepaymentType RepaymentType { get; set; } = PurpleBank.Models.BankingLoanAccountV2RepaymentType.PRINCIPAL_AND_INTEREST;
    ...
    public partial class BankingScheduledPaymentRecurrenceIntervalSchedule
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public BankingScheduledPaymentRecurrenceIntervalScheduleNonBusinessDayTreatment NonBusinessDayTreatment { get; set; } = PurpleBank.Models.BankingScheduledPaymentRecurrenceIntervalScheduleNonBusinessDayTreatment.ON;
    ...
    public partial class BankingScheduledPaymentRecurrenceLastWeekday
    {
        ...
        [Newtonsoft.Json.JsonProperty("nonBusinessDayTreatment", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public BankingScheduledPaymentRecurrenceLastWeekdayNonBusinessDayTreatment NonBusinessDayTreatment { get; set; } = PurpleBank.Models.BankingScheduledPaymentRecurrenceLastWeekdayNonBusinessDayTreatment.ON;
    ...
    public partial class ResponseErrorListV2
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.Generic.ICollection<ResponseErrorListV2_errors> Errors { get; set; } = new System.Collections.ObjectModel.Collection<ResponseErrorListV2_errors>();
